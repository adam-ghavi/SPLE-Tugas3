package aisco.product.adam3config;
...
import aisco.notification.NotificationFactory;
import aisco.notification.core.Notification;

public class Adam3Config {
	...
	private static Notification notificationNotification;
	private static Notification emailNotification;
